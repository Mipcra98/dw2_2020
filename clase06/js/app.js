...
function procesar()
    {
      ...
      {
      datos.push([document.getElementById('nombre').value,document.getElementById('apellido').value,document.getElementById('fenac').value]);
    } else {
...
document.getElementById('apellido').value=datos[idx][1];
